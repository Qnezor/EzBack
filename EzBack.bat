...
echo   / __/__ / _ )___ _____/ /__  / __/ / _ \
echo  / _//_ // _  / _ `/ __/  '_/ / _ \_/ // /
echo /___//__/____/\_,_/\__/_/\_\  \___(_)___/                                                                                           
echo.
...
echo  7 - Google Lens
echo  8 - Google
echo  9 - Google Movies
echo  10 - Google Photos
...
:lens
start cmd.exe /k %adbfolder%adb shell pm uninstall --user 0 com.google.ar.lens
set appdel=Google Lens
goto godelinfo

:google
start cmd.exe /k %adbfolder%adb shell pm uninstall --user 0 com.google.android.googlequicksearchbox
set appdel=Google
goto godelinfo

:movies
start cmd.exe /k %adbfolder%adb shell pm uninstall --user 0 com.google.android.videos
set appdel=Google Movies
goto godelinfo

:photo
start cmd.exe /k %adbfolder%adb shell pm uninstall --user 0 com.google.android.apps.photos
set appdel=Google Photos
goto godelinfo

:health
start cmd.exe /k %adbfolder%adb shell pm install-existing --user 0 com.google.android.apps.turbo
set appdel=Google Device Health Services
goto godelinfo

:auto
start cmd.exe /k %adbfolder%adb shell pm uninstall --user 0 com.google.android.projection.gearhead
set appdel=Android Auto
goto godelinfo

:chrome
start cmd.exe /k %adbfolder%adb shell pm uninstall --user 0 com.android.chrome
set appdel=Google Chrome
goto godelinfo

:gmail
start cmd.exe /k %adbfolder%adb shell pm uninstall --user 0 com.google.android.gm
set appdel=Gmail
goto godelinfo

:YouTube
start cmd.exe /k %adbfolder%adb shell pm uninstall --user 0 com.google.android.youtube
set appdel=YouTube
goto godelinfo
